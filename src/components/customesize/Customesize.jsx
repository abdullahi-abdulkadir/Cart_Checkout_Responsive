...
const Customesize = () => {
  ...
  const handleSave = () => {
    ...
    const emptyFields = Object.entries(measurements).filter(([key, value]) => value === "");
  
    // Check checkboxes
    const longSleeveChecked = document.querySelector('input[name="longSleeve"]')?.checked;
    const longTrouserChecked = document.querySelector('input[name="longTrouser"]')?.checked;
    ...
    // Validate checkboxes
    if (!longSleeveChecked || !longTrouserChecked) {
      setError("Please check the required options before saving.");
      return;
    }
      ...
      <form>
        ...
        <div className="level-2">
           <label > <p>Long Sleeve</p>
             ...
             <input type="checkbox" name="longSleeve" required />
        ...
        <div className="level-6">
           <label> <p>Long Trouser</p>
             <label className="switch">
             <input type="checkbox" name="longTrouser" required />
               <span className="slider round"></span>
             </label>
             <p>  Short Trauser</p>
          </label>
        ...
        <div className='input-center'>
          <h4> Cap Size  {"\u00a0 "} {"\u00a0 "}
            <input type='text' name='capSize' id='capSize' placeholder=' 145 cm' value={measurements.capSize} onChange={updateValue} required/>
          </h4>
          <br/>
          <h4>Shoe Size {"\u00a0 "}
            <input type='text' name='shoesSize' id='shoeSize' placeholder=' 45' value={measurements.shoesSize} onChange={updateValue} required/>
          </h4>
        </div>

        {/* Other Specifications */}
        <div className="others-container">
          <input type='text' name='otherSpecification' id="others-input" placeholder='Others Specification' value={measurements.otherSpecification} onChange={updateValue} required/>
        </div>
